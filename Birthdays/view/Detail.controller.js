sap.ui.core.mvc.Controller.extend("Birthdays.view.Detail", {
    ...
    sendGreetingEmail : function() {
        ...
        window.location.href = "mailto:" + selectedEmployee.cust_emailAddress + 
...
// 			}
	...
	bindView : function (sEntityPath) {
		...
		var urlPrefix = "";
		//------ fix FLP query url
		if(window.location.hostname.indexOf("flp") == 0) {
		    var urlparams = window.location.hash.split('&');
		    var appName;
		    for(var i in urlparams) {
		        if(urlparams[i].split('=')[0] == "html5App") {
		            appName = urlparams[i].split('=')[1];
		            break;
		        }
		    }
		    var urlPrefix = window.location.origin = "/sap/fiori/" + appName;
		}
		//--------------------------

		var photoQueryPath = urlPrefix + "/destinations/sfsfodata/odata/v2" + "/Photo(photoType=1,userId='" + bday.externalCode + "')?$format=json";
